...
const FLEET = [
  ...
  },
  {
    ...
    classId: 'first',
    caption: 'Gulfstream G700 — флагман дальних линий',
    desc: 'Самый просторный салон в бизнес-авиации и рекордная дальность: два континента без посадки на скорости почти в звук. Пять жилых зон, панорамные иллюминаторы и полноценная каюта с душем.',
    specs: [
      ['Дальность', '13 890 км'],
      ['Скорость', '0.925 Маха'],
      ['Гостей', 'до 19'],
