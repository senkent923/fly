...
const ITEMS = [
  ...
  },
  {
    ...
    a: 'Стоимость рассчитывается автоматически по дальности маршрута и выбранному классу (Стандарт / Бизнес / Приват), умноженной на число пассажиров. Перелёт «туда-обратно» считается по обоим плечам со скидкой на обратный рейс.',
  },
  {
  ...
  },
  {
    ...
    a: 'Оплата — картой онлайн (в этой демоверсии списание не производится). Возврат возможен до подтверждения вылета — свяжитесь с консьержем, и мы оформим его без комиссии.',
  },
  {
